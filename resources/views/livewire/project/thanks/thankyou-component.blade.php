                ...
                <div class="row">
                    <div class="col-md-12 text-center wow fadeIn mt-n3" data-wow-delay="300ms">
                        <h2 class="heading bottom30 darkcolor font-light2 pt-1"><span
                                class="font-normal">Başvuru</span> Sonucu
                            <span class="divider-center"></span>
                        </h2>
                        <h3 class="darkcolor font-normal mb-4">
                            <img width="100" src="{{asset('assets')}}/icons/okay.png" alt=""><br>
                            Bursluluk Sınavı Başvurunuz Başarıyla Gerçekleşmiştir!</h3>
               
                       <a href="/basvurular" > <button class="btn btn-success"> Başvurunuzu Sorgulayın </button> </a>
                    </div>
